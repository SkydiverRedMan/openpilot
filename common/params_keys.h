...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AdjacentLeadsUI", {PERSISTENT, BOOL, "0", "0", 3}},
    {"AdjacentPath", {PERSISTENT, BOOL, "1", "0", 3}},
    ...
    {"AlwaysOnLateralLKAS", {PERSISTENT, BOOL, "0", "0", 2}},
    ...
    {"CECurves", {PERSISTENT, BOOL, "1", "0", 1}},
    ...
    {"DisengageVolume", {PERSISTENT, INT, "30", "101", 2}},
    ...
    {"DriverCamera", {PERSISTENT, BOOL, "1", "0", 1}},
    ...
    {"EngageVolume", {PERSISTENT, INT, "50", "101", 2}},
    ...
    {"GoatScream", {PERSISTENT, BOOL, "1", "0", 1}},
    {"GreenLightAlert", {PERSISTENT, BOOL, "1", "0", 0}},
    ...
    {"LaneChangeTime", {PERSISTENT, FLOAT, "0.5", "0.0", 1}},
    ...
    {"LeadDepartingAlert", {PERSISTENT, BOOL, "1", "0", 0}},
    ...
    {"LongitudinalActuatorDelay", {PERSISTENT, FLOAT, "0.15", "0.0", 3}},
    {"LongitudinalActuatorDelayStock", {PERSISTENT, FLOAT, "0.15", "0.0", 3}},
    ...
    {"Offset4", {PERSISTENT, FLOAT, "8.0", "0.0", 0}},
    {"Offset5", {PERSISTENT, FLOAT, "8.0", "0.0", 0}},
    {"Offset6", {PERSISTENT, FLOAT, "11.0", "0.0", 0}},
    {"Offset7", {PERSISTENT, FLOAT, "11.0", "0.0", 0}},
    {"OneLaneChange", {PERSISTENT, BOOL, "1", "0", 2}},
    {"OnroadDistanceButton", {PERSISTENT, BOOL, "1", "0", 0}},
    ...
    {"RandomEvents", {PERSISTENT, BOOL, "1", "0", 1}},
    {"RandomThemes", {PERSISTENT, BOOL, "1", "0", 1}},
    ...
    {"ScreenTimeout", {PERSISTENT, INT, "60", "30", 2}},
    {"ScreenTimeoutOnroad", {PERSISTENT, INT, "60", "10", 2}},
    ...
    {"ShowStoppingPoint", {PERSISTENT, BOOL, "0", "0", 3}},
    {"ShowStoppingPointMetrics", {PERSISTENT, BOOL, "0", "0", 3}},
    ...
    {"SLCLookaheadHigher", {PERSISTENT, INT, "7", "0", 2}},
    {"SLCLookaheadLower", {PERSISTENT, INT, "3", "0", 2}},
    ...
    {"SLCPriority2", {PERSISTENT, STRING, "Navigation", "Dashboard", 2}},
    ...
    {"SpeedLimitChangedAlert", {PERSISTENT, BOOL, "1", "0", 0}},
    ...
    {"SpeedLimitSources", {PERSISTENT, BOOL, "1", "0", 3}},
    ...
    {"SteerDelay", {PERSISTENT, FLOAT, "0.12", "0.0", 3}},
    {"SteerDelayStock", {PERSISTENT, FLOAT, "0.12", "0.0", 3}},
    {"SteerFriction", {PERSISTENT, FLOAT, "0.159727", "0.0", 3}},
    {"SteerFrictionStock", {PERSISTENT, FLOAT, "0.159727", "0.0", 3}},
    {"SteerKP", {PERSISTENT, FLOAT, "1.0", "0.0", 3}},
    {"SteerKPStock", {PERSISTENT, FLOAT, "1.0", "0.0", 3}},
    {"SteerLatAccel", {PERSISTENT, FLOAT, "1.81", "0.0", 3}},
    {"SteerLatAccelStock", {PERSISTENT, FLOAT, "1.810835", "0.0", 3}},
    {"SteerRatio", {PERSISTENT, FLOAT, "16.0", "0.0", 3}},
    {"SteerRatioStock", {PERSISTENT, FLOAT, "16.0", "0.0", 3}},
    {"StockDongleId", {PERSISTENT, STRING, "", ""}},
    {"StopAccel", {PERSISTENT, FLOAT, "-2.0", "0.0", 3}},
    {"StopAccelStock", {PERSISTENT, FLOAT, "-2.0", "0.0", 3}},
    {"StoppedTimer", {PERSISTENT, BOOL, "0", "0", 1}},
    {"StoppingDecelRate", {PERSISTENT, FLOAT, "0.3", "0.0", 3}},
    {"StoppingDecelRateStock", {PERSISTENT, FLOAT, "0.3", "0.0", 3}},
    {"SubaruSNG", {PERSISTENT, BOOL, "1", "0", 2}},
    {"TacoTune", {PERSISTENT, BOOL, "1", "0", 2}},
    ...
    {"ToyotaDoors", {PERSISTENT, BOOL, "0", "0", 0}},
    {"TuningLevel", {PERSISTENT, INT, "3", "0", 0}},
    {"TuningLevelConfirmed", {PERSISTENT, BOOL, "1", "0", 0}},
    ...
    {"VEgoStarting", {PERSISTENT, FLOAT, "0.25", "0.0", 3}},
    {"VEgoStartingStock", {PERSISTENT, FLOAT, "0.25", "0.0", 3}},
    {"VEgoStopping", {PERSISTENT, FLOAT, "0.25", "0.0", 3}},
    {"VEgoStoppingStock", {PERSISTENT, FLOAT, "0.25", "0.0", 3}},
